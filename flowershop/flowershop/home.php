...
<body>
  ...
  <section class="home_cont">
    <div class="main_descrip">
      ...
      <p>Brighten Your Day with Blooms, Bouquets, and Botanical Beauty</p>
      <button class="product_btn" onclick="window.location.href='shop.php';">Shop Now</button>
    </div>
  </section>
  ...
  <section class="about_cont">
    ...
    <p>
      At The Flower Shop, we are passionate about sharing the beauty and joy of flowers with our community. Our shop is more than just a place to buy flowers; it's a sanctuary for flower lovers, where creativity blooms and every bouquet tells a story. We believe in the power of flowers to brighten days, celebrate special moments, and bring people together. Let us be part of your journey, adding color, fragrance, and meaning to life’s unforgettable moments.
    </p>
